...
@Service
public class ClientGetBooksKafkaConsumer implements GetBooksKafkaConsumer {

    private static final Logger LOGGER = LoggerFactory.getLogger(ClientGetBooksKafkaConsumer.class);
